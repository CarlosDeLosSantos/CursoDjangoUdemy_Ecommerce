...
class Order(models.Model):
    ...
    created_at = models.DateTimeField(auto_now_add=True)
    pdated_at = models.DateTimeField(auto_now=True) #Corregir posteriormente a "updated" realizando la respectiva migration
    
    #PAra obtener el nombre completo
    def full_name(self):
        return f'{self.first_name} {self.last_name}'
    
    #PAra concatenar las direcciones
...
#Para los productos dentro de la orden
#Tabla Pivote
