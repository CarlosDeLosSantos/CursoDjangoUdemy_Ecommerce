...
def register(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            #Generar perfil de usuario default desde la creación de cuenta en DB
            profile = UserProfile()
...
#Para visulaizar las ordenes de compra
    ...
    if request.method == 'POST':
        ...
        if new_password == confirm_password:
            ...
            if success:
                ...
                messages.success(request, 'El Password Se Actualizó Correctamente')
                return redirect('change_password')
            else:
                messages.error(request, 'Por Favor Ingrese Un Password Válido')
                return redirect('change_password')
        else:
            messages.error(request,'El PasWord No Coincide Con La Confirmación Del Password')
            return redirect('change_password')
