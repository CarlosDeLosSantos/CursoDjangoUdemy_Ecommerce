...
#Formulario para actualizar el userProfile
...
#Formulario apra actualizar imagen de perifl
class UserProfileForm(forms.ModelForm):
    profile_picture = forms.ImageField(required=False, error_messages={'invalid':('Solo Archivos de Imágen')}, widget=forms.FileInput)
    class Meta:
        model = UserProfile
